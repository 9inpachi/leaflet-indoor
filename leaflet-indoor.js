...
L.Indoor = L.Layer.extend({
    ...
    getBounds: function () {
        var allPoints = [];
        var rootScope = this;
        Object.keys(this._layers).forEach(function (parentLayerKey) {
            Object.keys(rootScope._layers[parentLayerKey]._layers).forEach(function (layerKey) {
                allPoints.push(rootScope._layers[parentLayerKey]._layers[layerKey].feature.geometry.coordinates.reverse())
            });
        });
        return allPoints;
    }
